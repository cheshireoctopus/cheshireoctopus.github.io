...
const GitHubLogo = () => (
  <svg width="30px" height="30px" viewBox="0 0 33 33" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
    <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <g id="GitHub-Mark" transform="translate(-136.000000, -55.000000)" fill="#161514">
  ...
  <FooterContainer>
    ...
    <div>
      ...
      <a href="https://dev.to/cheshireoctopus">
        <img src="https://d2fltix0v2e0sb.cloudfront.net/dev-badge.svg" alt="Chandler Moisen's DEV Profile" height="30" width="30" />
      </a>
    </div>
  </FooterContainer>
)
